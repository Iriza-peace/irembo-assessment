...
const countries = [
  ...
  { code: '+256', name: 'United Kingdom' },
  { code: '+91', name: 'United States' },
  {code: '+254', name: 'Kenya'},
];
...
const DetailForm = () => {
  ...
  <div className="flex flex-col border w-full md:mx-auto px-3 md:px-8 pt-5">
    ...
    <button
        type="submit"
        className="w-[60vw] mb-6 flex justify-center mx-auto text-sm px-4 py-3 text-white bg-blue-800 rounded-3xl hover:bg-blue-700"

        disabled={loading}
      >
        {loading ? 'Registering Information...' : 'Register Information'}
      </button>
  </form>
</div>
